...
def calc(msq, mglu, mO)
  modify_run_card $proc_dir, msq, msq
  modify_param_card $proc_dir, msq, mglu, mO

  run_dir = "scan_#{msq}_#{mglu}_#{mO}"
...
data_file = $proc_dir + '.data'

if File.exist? data_file
  csv = CSV.read(data_file, converters: :numeric, col_sep: ' ')
end

msq_a = linspace(500.0, 3000.0, 100.0)
mglu_a = linspace(500.0, 3000.0, 100.0)
